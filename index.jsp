...
<!--/main-header-->
 ...
 <!--//main-header-->
	         <!--/banner-bottom-->
			  <div class="w3_agilits_banner_bootm" style="margin-top: -40px;">
			...
			<%
				...
				{
					status = (String)request.getAttribute("result");
					System.out.println(" in "+status);
				}
				System.out.println(" out "+status);
			%>
			<center><p style="color :green;"><%=status %></p></center>
			<!--//banner-bottom-->
		     <!-- Modal1 -->
									...
									<div class="modal-header">
										...
										<div class="login-form">
											<form action="UserLogin" method="post">
												<input type="email" name="usermail" placeholder="E-mail" required="">
												...
												<div class="forgot-grid">
												       <div class="log-check">
														<label class="checkbox"><input type="checkbox" value="admin" name="checkbox">Admin</label>
														</div>
														<div class="forgot">
