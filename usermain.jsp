<%@ page language="java" import="java.util.*" import="java.io.*" import="java.sql.*" pageEncoding="ISO-8859-1"%>
<%
...
<!--/main-header-->
  ...
  <%
  		...
  		//PreparedStatement ps = con.prepareStatement("select * from videoregister where usermail=?");
